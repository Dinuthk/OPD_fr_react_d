...
//import AlertUserDelete from './components/user-delete-alert';
...
const PatientListPage = () => {
  ...
  return (
    <MainCard content={false}>
      <ScrollX>
        <PatientTable columns={columns} handleAdd={handleAdd} getHeaderProps={(column) => column.getSortByToggleProps()} />
      </ScrollX>
      ...
      >
        <AddPatient user={user} onCancel={handleAdd} />
      </Dialog>
    </MainCard>
  );
};
