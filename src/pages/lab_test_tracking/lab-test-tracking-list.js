...
import LabTestTable from './components/lab-test-table';
import ScrollX from 'components/ScrollX';
import { Chip, Dialog, IconButton, Stack, Tooltip, Typography, useTheme } from '@mui/material';
import AddLabTest from './components/add-lab-test';
...
import AlertLabTestDelete from './components/lab-test-delete-alert';
...
const LabTestTracking = () => {
  ...
  return (
    <MainCard content={false}>
      <ScrollX>
        <LabTestTable columns={columns} handleAdd={handleAdd} getHeaderProps={(column) => column.getSortByToggleProps()} />
      </ScrollX>
      <AlertLabTestDelete title={deletingUser.name} userId={deletingUser._id} open={open} handleClose={handleClose} />
      {/* add user dialog */}
      <Dialog
        maxWidth="sm"
      ...
      >
        <AddLabTest user={user} onCancel={handleAdd} />
      </Dialog>
    </MainCard>
  );
};

export default LabTestTracking;
