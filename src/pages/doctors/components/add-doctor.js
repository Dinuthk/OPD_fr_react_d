      ...
      <FormikProvider value={formik}>
        <LocalizationProvider dateAdapter={AdapterDateFns}>
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            <DialogTitle>{user ? 'Edit User' : 'Add Doctor'}</DialogTitle>
            <Divider />
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8}>
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                      <Stack spacing={1.25}>
                        <InputLabel htmlFor="user-availabletime">Available Time</InputLabel>
                        <TextField
                          fullWidth
                          type="time"
                          id="user-availabletime"
