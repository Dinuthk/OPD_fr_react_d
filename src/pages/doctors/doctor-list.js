...
//import AlertDoctorDelete from './components/doctor-delete-alert';
...
const DoctorListPage = () => {
  ...
  return (
    <MainCard content={false}>
      <ScrollX>
        <DoctorTable columns={columns} handleAdd={handleAdd} getHeaderProps={(column) => column.getSortByToggleProps()} />
      </ScrollX>
      <AlertDoctorDelete title={deletingUser.name} userId={deletingUser._id} open={open} handleClose={handleClose} />
      {/* add user dialog */}
      <Dialog
        maxWidth="sm"
      ...
      >
        <AddDoctor user={user} onCancel={handleAdd} />
      </Dialog>
    </MainCard>
  );
};
